...
dotnet restore dotnetcore\src\ConsoleDotNetCore1.0 --verbosity Error

dotnet restore dotnetcore\src\ConsoleDotNetCore1.1 --verbosity Error

dotnet build dotnetcore\src\ConsoleDotNetCore1.0 

dotnet build dotnetcore\src\ConsoleDotNetCore1.1 
...
dotnet run -p dotnetcore\src\ConsoleDotNetCore1.0 
dotnet run -p dotnetcore\src\ConsoleDotNetCore1.1 